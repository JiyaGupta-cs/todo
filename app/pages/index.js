...
const Home = () => {
    const { initialized, initializeUser, loading, transactionPending, completedTodos, incompleteTodos, markTodo, removeTodo, markStaticTodo,removeStaticTodo, addTodo, input,  handleChange } = useTodo()
